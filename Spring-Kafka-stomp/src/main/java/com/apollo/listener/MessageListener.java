...
public class MessageListener {
	...
	@KafkaListener(id = "stomp-test-topic-listener-0", group = "quake-topic-group", topicPartitions = {
			@TopicPartition(topic = "quake-topic", partitions = { "0" }) })
	...
	@KafkaListener(id = "stomp-test-topic-listener-1", group = "quake-topic-group", topicPartitions = {
			@TopicPartition(topic = "quake-topic", partitions = { "1" }) })
